    ...
    public partial class ini : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1358), false, 100000L, null, "Golden", null },
                    { 2L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1365), false, 75000L, null, "Silver", null },
                    { 3L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1369), false, 50000L, null, "Bronze", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1410), false, null, "1000", true, null },
                    { 2L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1415), false, null, "2000", false, null },
                    { 3L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1419), false, null, "3000", false, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1457), false, null, "Real", null },
                    { 2L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1462), false, null, "Legal", null }
                });

            migrationBuilder.InsertData(
                table: "PackageTariff",
                columns: new[] { "Id", "EnglishTariff", "FarsiTariff", "IdPackageSMS", "IdSarKhat", "InsertTime", "IsRemoved", "RemoveTime", "UpdateTime" },
                values: new object[] { 1L, "25", "30", 1L, 1L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1001), false, null, null });

            migrationBuilder.InsertData(
                table: "PackageTariff",
                columns: new[] { "Id", "EnglishTariff", "FarsiTariff", "IdPackageSMS", "IdSarKhat", "InsertTime", "IsRemoved", "RemoveTime", "UpdateTime" },
                values: new object[] { 2L, "35", "40", 2L, 2L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1008), false, null, null });

            migrationBuilder.InsertData(
                table: "PackageTariff",
                columns: new[] { "Id", "EnglishTariff", "FarsiTariff", "IdPackageSMS", "IdSarKhat", "InsertTime", "IsRemoved", "RemoveTime", "UpdateTime" },
                values: new object[] { 3L, "45", "50", 3L, 3L, new DateTime(2022, 8, 21, 15, 11, 8, 139, DateTimeKind.Local).AddTicks(1081), false, null, null });
