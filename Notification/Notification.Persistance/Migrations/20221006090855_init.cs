    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5031), false, null, "مدارک احراز هویت", null },
                    { 2L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5046), false, null, "شناسنامه", null },
                    { 3L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5048), false, null, "کارت ملی", null },
                    { 4L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5051), false, null, "فیش پرداختی", null },
                    { 5L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5053), false, null, "جواز", null },
                    { 6L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5057), false, null, "خرید خط", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5375), false, 100000L, null, "Golden", null, 0.80000000000000004 },
                    { 2L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5384), false, 75000L, null, "Silver", null, 0.90000000000000002 },
                    { 3L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5387), false, 50000L, null, "Bronze", null, 0.94999999999999996 },
                    { 4L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5390), false, 0L, null, "Ziro", null, 1.0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5110), false, 1, null, "  کد تایید شما = %1% است.", "وریفای", null },
                    { 2L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5116), false, 1, null, " به اپلیکیشن %1% خوش امدید.", "خوش امد گویی", null },
                    { 3L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5120), false, 2, null, "  سلام. %1% عزیز به اپلیکیشن %2% خوش آمدید.", "خوش امد گویی  کاربر خاص", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(4749), false, null, "مدیر", null },
                    { 2L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(4812), false, null, "کاربر", null },
                    { 3L, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(4816), false, null, "اپراتور", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 77.0, 1.2, 1.0, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5422), 1.2, false, 1.0, 1.5, null, "1000", 1, 1.8999999999999999, null },
                    { 2, 82.0, 1.2, 1.0, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5435), 1.2, false, 1.0, 1.5, null, "2000", 2, 1.8999999999999999, null },
                    { 3, 77.599999999999994, 1.2, 1.0, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5438), 1.2, false, 1.0, 1.5, null, "3000", 2, 1.8999999999999999, null },
                    { 4, 77.599999999999994, 1.2, 1.0, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5444), 1.2, false, 1.0, 1.5, null, "5000", 3, 1.8999999999999999, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5481), false, null, "Real", null },
                    { 2, new DateTime(2022, 10, 6, 12, 38, 54, 753, DateTimeKind.Local).AddTicks(5486), false, null, "Legal", null }
                });
