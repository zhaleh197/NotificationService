...
{
    public class SendOnceSMSWorker2 : BackgroundService
    {

        private readonly ChannelQueue<SMSAddedinQueue> _checkQueueSMSModelChannel;

        private readonly ChannelQueue<OnceMessage2> _channeloncesendSMS;
        ...
        public SendOnceSMSWorker2(
            ChannelQueue<OnceMessage2> channeloncesendSMS,
