...
{
    public class AddKhatWorker: BackgroundService
    {
        private readonly ChannelQueue<KhatAdded> _readModelChannel;
        private readonly ILogger<AddKhatWorker> _logger;
        private readonly IServiceProvider _serviceProvider;
        // private readonly IGetSMS _getSMS;
        // private readonly IPostSMS _postSMS;

        public AddKhatWorker(ChannelQueue<KhatAdded> readModelChannel,
            ILogger<AddKhatWorker> logger, 
            IServiceProvider serviceProvider)//, IPostSMS postSMS)
        {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            while (!stoppingToken.IsCancellationRequested)
            {
                ...
                try
                {
                    ...
                    { 
                        var khat = Khat.GetKhatbyId(item.Idkhat); 
